    ...
    <View style={{
      ...
      <KeyboardAwareScrollView>
        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <Text style={{ textAlign: "center", fontFamily: fonts.SfPro_Bold, fontSize: 22, flex: 3, }}>Add Event</Text>
          <View style={{ flex: 1 }} />
        </View>
        <View style={{ marginHorizontal: width * .03, }}>
          ...
          <View>
            ...
            <View style={{ flexDirection: 'row', width: width * 1, marginTop: 20 }}>
              <TouchableOpacity onPress={() => { setShowEventStart(true), setOpen(true) }} style={{ width: width * 0.45, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, justifyContent: 'flex-start', borderRadius: 5, borderColor: "#8B93A1", borderWidth: 1, height: 40 }}>
              ...
              <TouchableOpacity onPress={() => { setOpen1(true), setShowEventStartTime(true) }} style={{ width: width * 0.45, marginLeft: width * 0.04, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, justifyContent: 'flex-start', borderRadius: 5, borderColor: "#8B93A1", borderWidth: 1, height: 40 }}>
          ...
          <View>
            ...
            <View style={{ flexDirection: 'row', width: width * 1, marginTop: 20 }}>
              <TouchableOpacity onPress={() => { setShowEventStart(false), setOpen(true) }} style={{ width: width * 0.45, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, justifyContent: 'flex-start', borderRadius: 5, borderColor: "#8B93A1", borderWidth: 1, height: 40 }}>
              ...
              <TouchableOpacity onPress={() => { setShowEventStartTime(false), setOpen1(true) }} style={{ width: width * 0.45, marginLeft: width * 0.04, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, justifyContent: 'flex-start', borderRadius: 5, borderColor: "#8B93A1", borderWidth: 1, height: 40 }}>
                <Image source={images.clock} style={{ height: 20, width: 20, resizeMode: "contain", }}></Image>
                <View style={{ marginLeft: 10, alignItems: 'center', justifyContent: 'center' }}>
